...
exports.defaultSvg = `
	<svg ${attrs}>
		...
		<circle fill="red" cx="48" cy="48" r="42" />
	</svg>`;
exports.battleSvg = (color) => `
	<svg ${attrs}>
		<circle fill="black" cx="48" cy="48" r="48" />
		<circle fill="${color}" cx="48" cy="48" r="42" />
	</svg>`;
exports.deathSvg = `<svg ${attrs}>
	<g style="fill: red">
		<rect x="36" y="0" width="24" height="96" />
		<rect x="12" y="24" width="72" height="24" />
	</g>
</svg>`;
exports.birthSvg = `<svg ${attrs}>
	<g style="fill: red">
		<polygon points="48,0 96,72 0,72" />
		<polygon points="48,96 96,24 0,24" />
	</g>
</svg>`;
exports.aerialBattleSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005" width="12" height="12">
	<g style="fill: red">
